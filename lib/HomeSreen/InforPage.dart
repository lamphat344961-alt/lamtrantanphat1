...
class InforPage extends StatelessWidget {
  ...
  final List<Member> members = const [
    Member(
      ...
      role: 'Developer',
      color: Colors.blue,
      email: 'phucbinh3008@gmail.com',
      specialty: 'Chưa thấy',
      experience: '0',
      hobbies: 'Đọc sách',
      avatar: 'assets/image/binh.jpg',
    ),
    Member(
      name: 'Đinh Quốc Khánh',
      role: 'Developer',
      color: Colors.green,
      email: 'quockhanh092005@gmail.com',
      specialty: 'Không có',
      experience: '0',
      hobbies: 'Đọc báo, xem thời sự',
      avatar: 'assets/image/khanh.jpg',
    ),
    Member(
      name: 'Bùi Trịnh Gia Bảo',
      role: 'Designer',
      color: Colors.purple,
      email: 'buibao32045@gmail.com',
      specialty: 'Developer',
      experience: '5 năm kinh nghiệm thiết kế ứng dụng',
      hobbies: 'Vẽ, du lịch, cà phê',
      avatar: 'assets/image/bao.jpg',
    ),
    // Có thể thêm người thứ 4 nếu bạn muốn:
    Member(
      name: 'Lâm Trần Tấn Phát',
      role: 'Designer',
      color: Color.fromARGB(255, 180, 8, 8),
      email: 'lamphat.344961@gmail.com',
      specialty: 'Data',
      experience: 'Khá nhiều',
      hobbies: 'Thám hiểm đại dương',
      avatar: 'assets/image/phat.jpg',
    ),
  ];
